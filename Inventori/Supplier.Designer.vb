...
Partial Class Supplier
    ...
    Private Sub InitializeComponent()
        ...
        Me.TCariData.CueHint.CueHintText = "Cari supplier..."
        ...
        Me.LBLNama.TabIndex = 182
        Me.LBLNama.Values.Text = "Nama Supplier"
        '
        'DGV
        '
        ...
        Me.LBLID.Values.Text = "ID Supplier"
        '
        'Supplier
        '
